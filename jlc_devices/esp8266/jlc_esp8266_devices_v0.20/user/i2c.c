...
// JA Note:
// 			Consider adding CCS style functions
//		output(pin,value);
//		output_low(pin);
//		output_high(pin);
//		input(pin);
//		set_as_input(pin);
//		set_as_output(pin);
//  The pin mappings on this are wrong, I suspect it only works for the first few GPIO lines.
//  modifiy code to work with all gpio lines
//
