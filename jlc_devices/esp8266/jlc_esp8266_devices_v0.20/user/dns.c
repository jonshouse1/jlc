...
// parse incoming query domain
    ...
    //os_printf("DNS Query Received [%s] from %d.%d.%d.%d\n",domain,premot->remote_ip[0],premot->remote_ip[1],premot->remote_ip[2],premot->remote_ip[3]);
