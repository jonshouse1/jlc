// Audioplus data consists of a block of stereo 16 but audio data plus some meta data about the audio stream.
...
struct audioplus
{
        ...
        int16_t mplayersamples[NUM_SAMPLES*2];          // 44.1Khz stereo interleaved data
